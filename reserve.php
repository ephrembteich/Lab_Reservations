<?php
    ...
    $name = intval($_POST['name']);	//problem: it is not being added to the record in the database
    //$title = $_POST(['title']);
//    $lab = 69;
//    $day = 25;
//    $month = 12;
//    $year = 2015;
    $startTime = 8;	//problem: it is not of the format 08:00:00
//    $name = "six09";
    $title = "cmps 211 final";
    $days = 0;
    $date = $year.$month.$day;
